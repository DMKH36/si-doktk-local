        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="font-weight-bold"><a href="/dokmasuk" style="color: #444">Daftar Dokumen Masuk</a></h2>
                    <ol>
                        <li><a href="/">Beranda</a></li>
                        <li>Daftar Dokumen Masuk</li>
                    </ol>
                </div>
            </div>
        ...
        <section class="dokumen mb-5" id="dokumen">
            <div class="container">
                <div class="section-header d-flex" style="justify-content: space-between">
                    <h2><a href="/dokmasuk" style="color: #0c2e8a">Dokumen Masuk</a></h2>
                    <form action="" method="GET" class="text-center mt-2">
                        <div class="input-group">
                            <input type="text" name="keyword" class="form-control" placeholder="Cari Dokumen"
                                value="{{ $keyword }}">
                            <button class="btn input-group-text btn-outline-secondary" type="submit">
                            ...
                            @foreach ($documents as $doc)
                                <div class="col-lg-4 col-md-6 dokumen-item">
                                    ...
                                    <div class="dokumen-info">
                                        ...
                                        <p class="m-0 p-0"><strong>{{ $doc->sender_name }}</strong></p>
