    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white"><strong>Edit Data Pengirim Surat</strong></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('sender.update', $data->id) }}" method="POST">
                <div class="modal-body">
                    @csrf
                    @method('put')
                    ...
                    <div class="col-12 mb-3">
                        <label for="name" class="form-label">Nama Pengirim <span
                    ...
                    <div class="col-12 mb-3">
                        <label for="address" class="form-label">Alamat Lembaga/Pengirim</label>
...
<div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                <form method="POST" action="{{ route('sender.destroy', $data->id) }}">
                    @csrf
                    @method('DELETE')
