                            ...
                            <div class="d-flex" style="justify-content: space-between">
                                <div>
                                    <button class="btn btn-success mb-1" data-bs-toggle="modal"
                                        data-bs-target="#importOutModal">
                                        <i class="bi bi-box-arrow-in-down"></i>&nbsp; Import Data
                                    </button>
                                    <a href="{{ route('doc.outpdf', 'keluar') }}" class="btn btn-primary mb-1">
                                        <i class="bi bi-file-earmark-pdf"></i>&nbsp; Export PDF
                                    </a>
                                    <a href="{{ route('doc.outexport') }}" class="btn btn-primary mb-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="text-center mb-2" style="margin-left: 10px; margin-top: 31px;">
                                        <a class="btn btn-info" target="_blank"
                                            onclick="this.href='/dashboard/document/outgoing/date/' + document.getElementById('startdate').value + '/' + document.getElementById('enddate').value">
                        ...
                        <table id="datatable" class="table datatable">
                            ...
                            <tbody>
                                @foreach ($keluar as $data)
                                    <tr style="vertical-align: middle" id="tr_{{ $data->id }}">
                                        @if ($user->role != 'kadep')
                                        ...
                                        <td style="vertical-align: middle">{{ $data->receiver_name }}</td>
                                        <td style="vertical-align: middle">
