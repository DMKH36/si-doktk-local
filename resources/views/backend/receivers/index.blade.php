...
@section('title', 'Penerima Surat')
@section('content')
    <!-- Page Title -->
    <div class="pagetitle">
        <h1>Penerima Surat</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item active">Penerima Surat</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-lg-16">
                <div class="card recent-sales overflow-auto">
                    <div class="card-body">
                        <h5 class="card-title">Data Penerima Surat</h5>
                        <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#addModal">
                            <i class="bi bi-person-plus text-white"></i>&nbsp; Tambah Penerima
                        </button>
                        @include('backend.receivers.modal-add')
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                @foreach ($receiver as $data)
                                    ...
                                    @include('backend.receivers.modal')
                                @endforeach
                            </tbody>
                        </table>
    ...
    <script>
        $(document).ready(function() {
            $("#user_id").change(function() {
                ...
                $.ajax({
                    url: "/dashboard/receiver/user/" + user_id,
                    type: "GET",
